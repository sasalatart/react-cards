...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Deck = __webpack_require__(210);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: "/decks/:id", component: _Deck2.default })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DeckForm = __webpack_require__(207);
	var RemoveForm = __webpack_require__(208);
	var Deck = __webpack_require__(210);
	var Helper = __webpack_require__(209);
	...
	var Table = _react2.default.createClass({
	  ...
	  handleDeckSubmit: function handleDeckSubmit(deck) {
	    deck.id = Date.now();
	    deck.cards = [];
	  ...
	  handleDeckRemove: function handleDeckRemove(decks) {
	  ...
	  render: function render() {
	    var deckNodes = this.state.decks.map((function (deck) {
	      return _react2.default.createElement(
	        "div",
	        { key: deck.id, className: "card ui tall stacked segment" },
	        _react2.default.createElement(
	          "div",
	          { className: "content" },
	          _react2.default.createElement(
	            "div",
	            { className: "header right aligned" },
	            _react2.default.createElement(RemoveForm, { type: "deck", deckId: deck.id, onRemove: this.handleDeckRemove })
	          ),
	          _react2.default.createElement(
	            "h2",
	        ...
	        _react2.default.createElement(
	          "a",
	          { href: "#/decks/" + deck.id, className: "ui red button" },
	          "Study"
	        )
	      );
	    }).bind(this));
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "h1",
	        { className: "ui center aligned red segment" },
	        "ReactCards"
	      ),
	      _react2.default.createElement(DeckForm, { onDeckSubmit: this.handleDeckSubmit }),
	      _react2.default.createElement(
	        "div",
	        { className: "ui three stackable link cards" },
	        deckNodes
	      )
	    );
	  }
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "div",
	          { className: "ui raised segment column" },
	          _react2.default.createElement(
	            "form",
	            { className: "ui form", onSubmit: this.handleSubmit },
	            _react2.default.createElement(
	              "a",
	              { className: "ui big red ribbon label" },
	              "Create a Deck!"
	            ),
	            _react2.default.createElement(
	              "div",
	              ...
	              _react2.default.createElement("input", { type: "submit", className: "ui inverted red button" })
	            )
	          )
	        )
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RemoveForm = _react2.default.createClass({
	  displayName: "RemoveForm",
	  ...
	  render: function render() {
	    return _react2.default.createElement("i", { className: "large red close link icon", onClick: this.handleRemove });
	  }
	});
...
/***/ function(module, exports) {
	...
	var Helpers = {
	  ...
	  setDecks: function setDecks(decks) {
	  ...
	  orderDeck: function orderDeck(deck) {
	    return deck.cards.sort(this.compare);
	  },

	  compare: function compare(cardA, cardB) {
	  ...
	  getDeck: function getDeck(deckId) {
	    return this.getDecks().filter(function (deck) {
	      return deck.id + "" === deckId + "";
	    })[0];
	  },

	  removeDeck: function removeDeck(deck) {
	    return _.reject(this.getDecks(), function (el) {
	      return el.id === deck.id;
	    });
	  },

	  removeCard: function removeCard(deck, cardId) {
	    return _.reject(deck.cards, function (el) {
	      return el.id === cardId;
	    });
	  },

	  createLSCard: function createLSCard(deck) {
	    var decks = this.getDecks();
	    decks = _.reject(decks, function (el) {
	      return el.id === deck.id;
	    });
	    decks.push(deck);
	    this.setDecks(decks);
	  ...
	  editLSCard: function editLSCard(card, cardId, deckId) {
	    card.id = cardId;
	    var decks = this.getDecks();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CardForm = __webpack_require__(211);
	var Card = __webpack_require__(212);
	var Helper = __webpack_require__(209);
	...
	var Deck = _react2.default.createClass({
	  ...
	  handleCardChange: function handleCardChange(deck) {
	  ...
	  render: function render() {
	    ...
	    var cardNodes = this.state.deck.cards.map((function (card) {
	      return _react2.default.createElement(Card, { key: card.id, id: card.id, deckId: this.state.deck.id,
	        position: card.position, fontSize: fontSize,
	        question: card.question, answer: card.answer,
	        onEdit: this.handleCardChange,
	        onRemove: this.handleCardChange });
	    }).bind(this));
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "a",
	        { href: "/react-cards/#/", className: "ui red button" },
	        _react2.default.createElement("i", { className: "long arrow left icon" })
	      ),
	      _react2.default.createElement(
	        "h1",
	        { className: "ui center aligned red segment" },
	      ...
	      _react2.default.createElement(CardForm, { deckId: this.state.deck.id, lastPosition: lastPosition,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CardForm = _react2.default.createClass({
	    ...
	    if (!this.state.editing) {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "div",
	            { className: "ui ten wide column raised segment" },
	            _react2.default.createElement(
	              "form",
	              { className: "ui form", onSubmit: this.handleSubmit },
	              _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement("input", { type: "text", placeholder: this.state.question, ref: "question" }),
	                _react2.default.createElement("input", { type: "text", placeholder: this.state.answer, ref: "answer" }),
	                _react2.default.createElement("input", { type: "number", value: this.props.lastPosition, ref: "position", className: "hidden" }),
	                _react2.default.createElement("input", { type: "submit", className: "ui inverted red button" })
	              )
	            )
	          )
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "div",
	              { className: "ui pointing below red label" },
	              "Question"
	            ),
	            _react2.default.createElement("input", { type: "text", defaultValue: this.state.question, ref: "question" })
	          ),
	          _react2.default.createElement(
	            "div",
	            { className: "field" },
	            ...
	            _react2.default.createElement("input", { type: "text", defaultValue: this.state.answer, ref: "answer" })
	          ),
	          _react2.default.createElement(
	            "div",
	            { className: "field" },
	            ...
	            _react2.default.createElement("input", { type: "number", defaultValue: this.props.position, ref: "position" })
	          ),
	          _react2.default.createElement(
	            "div",
	            { className: "center aligned" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Card = _react2.default.createClass({
	  ...
	  handleCardRemove: function handleCardRemove(deck) {
	    this.props.onRemove(deck);
	  },
	  ...
	  handleEditCard: function handleEditCard(card) {
	    this.toggleEditForm();
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "div",
	          { className: "header right floated" },
	          _react2.default.createElement(
	            "div",
	            { className: this.props.fontSize },
	            _react2.default.createElement("i", { className: "large red edit link icon", ref: "editButton", onClick: this.toggleEditForm }),
	            _react2.default.createElement(RemoveForm, { type: "card", deckId: this.props.deckId, cardId: this.props.id, onRemove: this.handleCardRemove })
	          )
	        ),
	        _react2.default.createElement(
	          "div",
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "button",
	              { className: "ui red button", onClick: this.toggle },
	              _react2.default.createElement(
	                "span",
	                { className: this.props.fontSize },
	                "See Answer"
	        ...
	        _react2.default.createElement(
	          "div",
	          { className: "hidden", ref: "editForm" },
	          _react2.default.createElement(CardForm, { question: this.state.question, answer: this.state.answer,
